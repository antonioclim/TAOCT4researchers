...
**Description:** Design and implement a benchmarking framework that measures algorithm performance with proper statistical rigour, including multiple runs, warmup periods and robust statistics.
