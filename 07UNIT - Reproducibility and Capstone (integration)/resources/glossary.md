...
A design pattern where dependencies are provided to a component rather than created within it. Facilitates testing by allowing mock objects to be substituted.
...
### Edge Case
An unusual or extreme input that may cause unexpected behaviour. Good tests specifically target edge cases to ensure robustness.
...
### Integration Test
A test that verifies the interaction between multiple components or systems. More comprehensive than unit tests but slower to execute.
...
### Reproducibility
The ability to obtain identical results using the same data, code and computational environment. A cornerstone of scientific validity.

### Research Software Engineering (RSE)
The application of software engineering practices to research contexts. RSEs specialise in developing robust, maintainable research software.
