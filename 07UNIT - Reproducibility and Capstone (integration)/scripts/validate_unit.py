...
word count validation, AI fingerprint detection, syntax verification,
and root file checks (README.md, Makefile, requirements.txt).
...
Usage:
    ...
    python validate_unit.py 07 --strict
"""
...
class UnitValidator:
    ...
    def scan_ai_fingerprints(self, content: str, filename: str) -> list[str]:
        """
        Scan content for AI-generated language patterns.
    ...
    def validate_html_naming(self) -> None:
        ...
        for path in html_files:
            ...
            self.results.append(ValidationResult(
                ...
                has_prefix,
                "✓ Has UNIT prefix" if has_prefix else
                f"⚠ Missing {self.unit}UNIT_ prefix",
    ...
    def print_report(self) -> None:
        ...
        for category, results in categories.items():
            ...
            for r in results:
                ...
                check_display = r.check[:35]
                msg_display = r.message[:28]
                print(f"│ {status} {check_display:<35} {msg_display:<28} │")
            print(f"└{'─' * 68}┘\n")
