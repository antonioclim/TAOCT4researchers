...
07UNIT, Lab 2: Testing Established Conventions and CI/CD
═══════════════════════════════════════════════════════════════════════════════
...
document expected behaviour, enable refactoring and enable effective team
collaboration.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="07UNIT Lab 2: Testing Established Conventions and CI/CD",
...
Testing Commands (with pytest installed):
  ...
  pytest --tb=short                # Short traceback
    ...
    if args.generate_ci:
        ...
        logger.info("07UNIT Lab 2: Testing Established Conventions and CI/CD")
