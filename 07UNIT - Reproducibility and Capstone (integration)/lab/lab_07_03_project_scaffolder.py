...
07UNIT, Lab 3: Project Scaffolder
═══════════════════════════════════════════════════════════════════════════════
...
professional project scaffolds that follow established conventions for reproducible
research.

PREREQUISITES
─────────────
- 07UNIT Lab 1: Reproducibility Toolkit
- 07UNIT Lab 2: Testing and CI/CD
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="07UNIT Lab 3: Project Scaffolder",
