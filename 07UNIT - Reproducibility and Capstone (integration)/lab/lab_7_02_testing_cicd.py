...
Week 7, Lab 2: Testing Best Practices and CI/CD
═══════════════════════════════════════════════════════════════════════════════
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Week 7 Lab 2: Testing Best Practices and CI/CD",
...
Testing Commands (with pytest installed):
  ...
  pytest --tb=short                # Short traceback
    ...
    if args.generate_ci:
        ...
        logger.info("Week 7 Lab 2: Testing Best Practices and CI/CD")
