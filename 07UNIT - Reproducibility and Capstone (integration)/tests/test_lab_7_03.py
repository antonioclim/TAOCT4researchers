...
Week 7: Test Suite for Lab 7.03 — Project Scaffolder
═══════════════════════════════════════════════════════════════════════════════
...
USAGE
─────
    pytest tests/test_lab_7_03.py -v
    pytest tests/test_lab_7_03.py -v -m integration
    pytest tests/test_lab_7_03.py -v --cov=lab
