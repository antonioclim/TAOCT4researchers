...
Week 7: Test Suite for Lab 7.02 — Testing and CI/CD
═══════════════════════════════════════════════════════════════════════════════
...
USAGE
─────
    pytest tests/test_lab_7_02.py -v
    pytest tests/test_lab_7_02.py -v -k "mock"
    pytest tests/test_lab_7_02.py -v --cov
