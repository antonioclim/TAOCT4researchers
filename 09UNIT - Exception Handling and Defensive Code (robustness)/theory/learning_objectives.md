...
Students will develop appreciation for the scientific imperative of consistent, failure-resistant computational tools. Through laboratory exercises demonstrating silent failures and cascading errors, students recognise that error handling is not optional overhead but necessary infrastructure for trustworthy research software.
