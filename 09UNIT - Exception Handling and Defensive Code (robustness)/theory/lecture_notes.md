...
6. **Design resilient systems**: Implement retry, circuit breaker and checkpoint patterns for resilient operation
...
- **10UNIT**: File handling with resilient error recovery
