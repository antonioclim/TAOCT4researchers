...
simple timing. This lab provides a thorough framework for measuring,
...
class BenchmarkResult:
    ...
    Stores detailed statistics for rigorous analysis:
    ...
    def median(self) -> float:
        """Median timing (more resistant to outliers than mean)."""
    ...
    @property
    def iqr(self) -> float:
        """Interquartile range (Q3 - Q1), outlier-resistant measure of spread."""
        if len(self.times) < 4:
            return self.std
...
class BenchmarkSuite:
    """
    Thorough benchmark suite for comparing algorithms.
