...
03UNIT, Lab 02: Complexity Analyser — Automatic Big-O Estimation
═══════════════════════════════════════════════════════════════════════════════
...
PREREQUISITES
─────────────
- 03UNIT Lab 01: BenchmarkSuite and BenchmarkResult classes
...
- Outlier-resistant statistics (median, IQR) handle outliers
...
class ComplexityAnalyser:
    """
    Thorough complexity analyser for empirical algorithm analysis.
