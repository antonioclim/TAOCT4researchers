...
Week 3, Lab 1: Benchmark Suite — Profiling and Optimisation
═══════════════════════════════════════════════════════════════════════════════
...
PREREQUISITES
─────────────
- Week 2: Object-oriented design, Strategy pattern
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Week 3 Lab: Benchmark Suite for Algorithm Analysis",
...
Examples:
  ...
  python lab_3_01_benchmark_suite.py -v --sizes 100 1000 10000
    ...
    logger.info("═" * 60)
    logger.info("  WEEK 3 LAB: BENCHMARK SUITE")
    logger.info("═" * 60)
