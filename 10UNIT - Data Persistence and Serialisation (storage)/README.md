...
> "Database systems epitomize this pattern, maintaining indices (In effect sorted or structured access paths) to accelerate queries at the cost of increased storage and update overhead."
