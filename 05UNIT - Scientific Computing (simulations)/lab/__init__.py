...
MODULES
───────
- lab_5_01_monte_carlo: Monte Carlo integration and estimation
- lab_5_02_ode_solvers: Ordinary differential equation solvers
- lab_5_03_agent_based_modelling: Agent-based simulation framework
