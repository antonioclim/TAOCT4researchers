...
4. **Metacognitive Prompts**: Self-assessment instruments fostering reflection on learning
...
Agent-based modelling gained prominence through Thomas Schelling's 1971 segregation model and Craig Reynolds' 1987 Boids algorithm, demonstrating how simple local rules generate complex global patterns—a paradigm now central to computational social science, ecology and artificial life research.
