...
Usage:
    ...
    python validate_unit.py 05
    python validate_unit.py 05 --strict
"""
...
AI_FINGERPRINTS_TIER1 = [
    "d" + "elve", "dive" + " into", "cru" + "cial", "piv" + "otal", "straight" + "forward",
    "lever" + "age", "ro" + "bust", "seam" + "less", "cutting" + "-" + "edge", "best" + " practices",
    "game" + "-" + "changer", "em" + "power", "har" + "ness", "land" + "scape", "para" + "digm",
    "syn" + "ergy", "hol" + "istic", "eco" + "system", "util" + "ize", "facili" + "tate",
    "bol" + "ster", "fos" + "ter", "under" + "score", "re" + "alm", "my" + "riad", "ple" + "thora",
    "corner" + "stone", "encom" + "passes", "intri" + "cacies",
]
...
AI_FINGERPRINTS_TIER3 = [
    r"^wel" + "come to", r"^in this com" + "prehensive", r"^let me ex" + "plain",
    r"happy " + "coding", r"good " + "luck!", r"have " + "fun!", r"stay " + "tuned",
    r"feel free " + "to", r"don't hesi" + "tate", r"i hope this " + "helps",
