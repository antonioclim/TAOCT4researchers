...
Week 2: Tests for Lab 2.02 — Design Patterns
═══════════════════════════════════════════════════════════════════════════════
...
class TestStrategyPattern:
    ...
    def test_rectangle_rule_constant(self):
        ...
        result = integrator.integrate(lambda x: 1.0, 0.0, 1.0, n=100)
    ...
    def test_rectangle_rule_linear(self):
        ...
        result = integrator.integrate(lambda x: x, 0.0, 1.0, n=1000)
    ...
    def test_trapezoid_rule_quadratic(self):
        ...
        result = integrator.integrate(lambda x: x**2, 0.0, 1.0, n=1000)
    ...
    def test_simpson_rule_polynomial(self):
        ...
        result = integrator.integrate(lambda x: x**3, 0.0, 1.0, n=100)
...
class TestFactoryPattern:
    ...
    def test_factory_produces_different_agents(self):
        ...
        assert type(coop_agent) != type(comp_agent)
...
class TestPatternIntegration:
    ...
    def test_strategy_with_observer(self):
        ...
        for a, b in [(0, 1), (0, 2), (1, 3)]:
            result = integrator.integrate(lambda x: x, a, b, n=100)
